...
public class LoginGUI extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            User u = crud_user.login(username, password);
            if(u!=null){
                if(u.getuType().equals("Assistant")){
                    this.setVisible(false);
                    new MainGUI(u.getUsername(),u.getuType()).setVisible(true);
                }else if(u.getuType().equals("Admin")){
                    this.setVisible(false);
                    new UserGUI().setVisible(true);
                }else {
                    this.setVisible(false);
                    new HomeMedecinGUI(u.getUsername()).setVisible(true);
                }
            }else {
                JOptionPane.showMessageDialog(this, "Login ou Password Incorrect! Try again");
                txtusername.setText("");
                txtpassword.setText("");
            }
